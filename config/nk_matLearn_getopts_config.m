    ...
    case 'get_learner_params'
        ...
        switch algo
            ...
            case 'TFDEEP'
                ...
                opt.sel = {[], ...
                            {'tensorflow', 'pytorch'},... 
                            {'linear', 'sigmoid', 'tanh', 'relu', 'elu', 'swish', 'softplus'}, ...
                            {'sgd', 'adam', 'adagrad'}, ...
                            [], ...
                            [], ...
                            [], ...
                ...
                switch framework
                    case 'classification'
                        opt.sel{13} = {'categorical_crossentropy', ...
                                       'kl_divergence', ...
                                       'categorical_hinge', ...
                                       'performance_criterion' ...
                                       };
                        opt.def{13} = 'categorical_crossentropy';

                        opt.format{13} = 'categorical_crossentropy|kl_divergence|categorical_hinge|performance_criterion (optimise NeuroMiner metric)';
                    ...
                    case 'regression'
                        ...
                        opt.def{13} = 'mean_squared_error';
                        opt.format{13} = 'mean_squared_error|mean_absolute_error|mean_absolute_percentage_error|huber|log_cosh|cosine_similarity|performance_criterion (optimize NeuroMiner metric)';
                 end
