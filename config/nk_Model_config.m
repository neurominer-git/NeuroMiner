    ...
    case 'classification'
        if EXPERT
            sftmenu = ['SVM --------------> LIBSVM|' ...
                       ...
                       'BAYES LINEAR -----> Python''s sklearn.linear_model.BayesianRidge|' ...  
                       ...
                       'DEEP NN ----------> Python''s tensorflow/pytorch neural network framework|'];
           sftval   = [ 'LIBSVM'; ...
                        'LIBLIN'; ...
                        'ELASVM'; ...
                        'MEXELM'; ...
...
switch act
    ...
    case 2
        ...
        switch SVM.prog
            ...
            case {'GLMNET','GRDBST', 'MLPERC', 'TFDEEP', 'BAYLIN'}
                if ~isfield(SVM,SVM.prog), SVM.(SVM.prog) = []; end
